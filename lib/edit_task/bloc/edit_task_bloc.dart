...
import 'package:todo_app_v2/edit_task/repository/task_service.dart';
...
class EditTaskBloc extends Bloc<EditTaskEvent, EditTaskState> {
  ...
  Future<void> _onSubmitted(
    ...
    const taskNoticationService = TaskNotificationService();

    final taskService = TaskService(
      todosRepository: _tasksRepository,
      recurringTaskFinder:
          RecurringTaskFinder(taskRepository: _tasksRepository),
      recurringTaskBuilder: RecurringTaskBuilder(
        todosRepository: _tasksRepository,
